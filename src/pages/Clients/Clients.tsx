          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-white/3 border-b border-border/10 text-text-secondary text-xs uppercase tracking-wider">
                ...
                <th className="text-left px-4 py-3 font-medium hidden md:table-cell">Ιδιότητα</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-border/10">
              {clients.map((c) => (
                ...
                >
                  ...
                  <td className="px-4 py-3 text-text-secondary hidden md:table-cell">{c.professional_status ?? '—'}</td>
                </tr>
              ))}
            </tbody>
          </table>
